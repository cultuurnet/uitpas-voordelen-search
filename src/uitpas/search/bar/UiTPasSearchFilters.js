...
export default class UiTPasSearchFilters extends React.Component {
  ...
  renderExtraOptionFilter() {
    ...
    return (
      <div className="sk-grid__12 sk-grid--bp-med__3">
        <Panel title="Extra opties" collapsable={true} defaultCollapsed={true}>
          <CheckboxFilter
            id="childrenFilter"
          ...
          <RefinementListFilter
            ...
            containerComponent={
              <Panel
                ...
                className="uitpassearch-filters-pnl-owningcardsystem"
              />
            }
          />
        </div>
