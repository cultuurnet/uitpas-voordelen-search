...
export default class UiTResultsLayout extends React.Component {
  componentWillMount() {
    ...
    if (
      ...
      !UiTPasSearchConfig.globalState.refreshSearchPerformed
    ) {
      // NOTE: It appears that run InitialSearch is the only way to bypass the similarity checks of
      ...
      // To make sure the query is really re-run, I also wipe the results.
      this.props.searchkit.results = null;
