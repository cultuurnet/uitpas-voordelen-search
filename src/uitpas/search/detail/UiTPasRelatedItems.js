              ...
              <div className="sk-grid">
                <div className="sk-grid__12">
                  <h2 className="sk-heading">
                    Andere voordelen in{" "}
                    {joinNicely(this.counterNames, ", ", " of ")}
                  </h2>
                </div>
              </div>
            </div>
            <div className="sk-block">{this.renderRelatedItems()}</div>
            <div className="sk-block">
              <div className="sk-grid">
                <div className="sk-grid__12">
  ...
  renderRelatedItems() {
    if (this.state.items) {
      if (this.state.items.length > 0) {
        return (
          <div className="sk-grid sk-grid--bp-sml-2-col sk-grid--bp-med-3-col uitpassearch-hits-grid">
        ...
        return (
          <div>
            Er zijn geen andere voordelen bij deze{" "}
            {this.counterNames && this.counterNames.length > 1
              ? "balies"
              : "balie"}
            ...
          </div>
    ...
    if (this.state.items && this.state.items.length > 0) {
      ...
      return (
        <div>
          <div>
            <a href={url}>
              Alle voordelen in {joinNicely(this.counterNames, ", ", " of ")}{" "}
              &raquo;
            </a>
          </div>
          <br />
