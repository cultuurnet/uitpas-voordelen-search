...
export default class UiTPasSearchHits extends SearchkitComponent {
  noHitsTranslation = {
    "NoHits.NoResultsFound":
      "Er werden geen UiTPAS-voordelen gevonden voor '{query}'.",
    ...
    "NoHits.NoResultsFoundDidYouMean":
      "Er werden geen UiTPAS-voordelen gevonden voor '{query}'. Bedoelde je '{suggestion}'?",
    "NoHits.Error":
      "Oeps! Er is wat misgelopen bij het ophalen van de UiTPAS voordelen. Probeer het later nog eens.",
    ...
    return (
      <div>
              ...
              <SortingSelector
                options={[
                  /*{ label: 'Meest recent', field: 'creationDate', order: 'desc', key: 'mostRecent', defaultOption: true },*/
                  {
                    ...
                    key: "mostRecent",
                    defaultOption: true,
                    fields: this.getMostRecentSortingFields(),
                  },
                  {
                    label: "Meest omgeruild",
                    field: "unitsTaken",
                    order: "desc",
                    key: "mostBartered",
                  },
                  {
                    label: "Punten laag - hoog",
                    field: "points",
                    order: "asc",
                    key: "pointsHighLow",
                  },
                  {
                    label: "Punten hoog - laag",
                    field: "points",
                    order: "desc",
                    key: "pointsLowHigh",
                  },
        ...
        <div className="uitpas-hits">
          ...
          />
          <NoHits
            translations={this.noHitsTranslation}
